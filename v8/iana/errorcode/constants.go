...
const (
	...
	KDC_ERR_DH_KEY_PARAMETERS_NOT_ACCEPTED      int32 = KDC_ERR_KEY_TOO_WEAK
	...
	KDC_ERR_INCONSISTENT_KEY_PURPOSE            int32 = 77  //Reserved for PKINIT
	KDC_ERR_DIGEST_IN_CERT_NOT_ACCEPTED         int32 = 78  //Reserved for PKINIT
	KDC_ERR_PA_CHECKSUM_MUST_BE_INCLUDED        int32 = 79  //Reserved for PKINIT
	KDC_ERR_DIGEST_IN_SIGNED_DATA_NOT_ACCEPTED  int32 = 80  //Reserved for PKINIT
	KDC_ERR_PUBLIC_KEY_ENCRYPTION_NOT_SUPPORTED int32 = 81  //Reserved for PKINIT
	...
	KDC_ERR_NO_ACCEPTABLE_KDF                   int32 = 100 //No acceptable PKINIT KDF
)
...
var errorcodeLookup = map[int32]string{
	...
	KDC_ERR_INCONSISTENT_KEY_PURPOSE:            "KDC_ERR_INCONSISTENT_KEY_PURPOSE PKINIT certificate key purpose is inconsistent",
	KDC_ERR_DIGEST_IN_CERT_NOT_ACCEPTED:         "KDC_ERR_DIGEST_IN_CERT_NOT_ACCEPTED PKINIT certificate digest is not accepted",
	KDC_ERR_PA_CHECKSUM_MUST_BE_INCLUDED:        "KDC_ERR_PA_CHECKSUM_MUST_BE_INCLUDED PKINIT paChecksum is required",
	KDC_ERR_DIGEST_IN_SIGNED_DATA_NOT_ACCEPTED:  "KDC_ERR_DIGEST_IN_SIGNED_DATA_NOT_ACCEPTED PKINIT CMS digest is not accepted",
	KDC_ERR_PUBLIC_KEY_ENCRYPTION_NOT_SUPPORTED: "KDC_ERR_PUBLIC_KEY_ENCRYPTION_NOT_SUPPORTED PKINIT public-key encryption is not supported",
	...
	KDC_ERR_NO_ACCEPTABLE_KDF:                   "KDC_ERR_NO_ACCEPTABLE_KDF No acceptable PKINIT KDF",
}
