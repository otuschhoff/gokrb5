...
It is recommended to use the latest version: [![Version](https://img.shields.io/github/release/otuschhoff/gokrb5.svg)](https://github.com/otuschhoff/gokrb5/releases)
...
|----------|-----------------------|-------------|-------|-------|----------------|
| [![v8](https://github.com/otuschhoff/gokrb5/workflows/v8/badge.svg)](https://github.com/otuschhoff/gokrb5/actions?query=workflow%3Av8) | Go modules | import "github.com/otuschhoff/gokrb5/v8/{sub-package}" | [![Usage](https://img.shields.io/badge/v8-usage-blue)](https://github.com/otuschhoff/gokrb5/blob/master/v8/USAGE.md) | [![GoDoc](https://img.shields.io/badge/godoc-reference-blue)](https://pkg.go.dev/github.com/otuschhoff/gokrb5/v8) | [![Go Report Card](https://goreportcard.com/badge/github.com/otuschhoff/gokrb5/v8)](https://goreportcard.com/report/github.com/otuschhoff/gokrb5/v8) |
| [![v7](https://github.com/otuschhoff/gokrb5/workflows/v7/badge.svg)](https://github.com/otuschhoff/gokrb5/actions?query=workflow%3Av7) | gopkg.in | import "gopkg.in/jcmturner/gokrb5.v7/{sub-package}" | [![Usage](https://img.shields.io/badge/v7-usage-blue)](https://github.com/otuschhoff/gokrb5/blob/master/USAGE.md) | [![GoDoc](https://img.shields.io/badge/godoc-reference-blue)](https://pkg.go.dev/github.com/otuschhoff/gokrb5@v7.5.0+incompatible) | [![Go Report Card](https://goreportcard.com/badge/gopkg.in/jcmturner/gokrb5.v7)](https://goreportcard.com/report/gopkg.in/jcmturner/gokrb5.v7) |


#### Go Version Support
![Go version](https://img.shields.io/badge/Go-1.27-brightgreen.svg)
...
* Server Side
  ...
  * Channel-binding enforcement, mutual authentication, constrained delegation, and RFC 4121 message protection
* Client Side
  ...
  * S4U2self, classic and resource-based S4U2proxy, FAST armor, and HTTPS KDC proxy transport
* General
  ...
  * Tagged integration tests against a pinned Samba AD domain controller and a manual Windows interoperability checklist
...
[contribution guide](https://github.com/otuschhoff/gokrb5/blob/master/CONTRIBUTING.md) as it should help you get started.
