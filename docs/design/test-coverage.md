...
**Baseline:** 65.9% cross-package statement coverage on 2026-09-07, measured with:
...
- Fail CI below 65.0%. The floor is intentionally below the 65.9% baseline to tolerate minor instrumentation differences across Go releases.
