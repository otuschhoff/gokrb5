...
**Baseline:** 65.0% cross-package statement coverage on 2026-09-07, measured with:
...
- Fail CI below 64.0%. The floor is intentionally below the 65.0% baseline to tolerate minor instrumentation differences across Go releases.
